...
const Login: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        console.log('Login user with email-pass: ', email, password);
                    ...
                    <div className={styles.loginFormArea}>
                        ...
                        <div className={styles.inputs}>
                            <form action="#" className={styles.loginForm} onSubmit={handleSubmit}>
                                ...
                                {/*</div>*/}
                                {/*<div className={styles.input}>*/}
                                <button className={styles.button} type="submit" tabIndex={3}>Login</button>
                                {/*</div>*/}
                            </form>
                        </div>
                        ...
                        <div className={styles.ssoButtons}>
                            <button className={styles.ssoButton} onClick={() => handleSSOLogin(signInWithGoogle)} tabIndex={4}>
                            ...
                            <button className={styles.ssoButton} onClick={() => handleSSOLogin(signInWithGithub)} tabIndex={5} >
                                <div className={styles.icons}>
